...
function parseConfigData() {
    ...
    var finalRulesPath = process.cwd() + path.sep + configObject.rulesPath;
    var finalDataPath = process.cwd() + path.sep + configObject.dataPath;

    console.log('Rules file path: ' + finalRulesPath);
    console.log('Response files directory: ' + finalDataPath);
    ...
    try {
        ...
        console.log('Rules file path did not resolve');
        ...
        if((apiList[i].serviceName === reqServiceName) && (apiList[i].apiName === reqApiName)) {
            ...
            if(flag) {
                ...
                try {
                    ...
                    console.log('Response file path did not resolve');
                    throw new Error(error);
                }
